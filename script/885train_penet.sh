export PYTHONPATH=/home/lvxinyu/lib/apex:/home/lvxinyu/lib/cocoapi:/home/lvxinyu/lib/Scene-Graph-Benchmark.pytorch-master:$PYTHONPATH

export CUDA_VISIBLE_DEVICES=1
export NUM_GUP=2
MODEL_NAME="intra_proto_only_cb_no_freq_no_ctx_no_relnms_predcls_bs8_miter60000_PQLayer_307_mlp4096_sub_loss307_parent_loss_rep_loss_neg_05_1024_PENet_9999899_memory10000_mem005_size64_cf09_dv05_SA"
...
cp ./maskrcnn_benchmark/modeling/roi_heads/relation_head/model_motifs.py ./checkpoints/${MODEL_NAME}/code
...
python tools/relation_train_net.py \
      ...
      MODEL.ROI_RELATION_HEAD.PREDICTOR VectorPredictor_mine_Memory \
      ...
      SOLVER.MAX_ITER 60000 SOLVER.VAL_PERIOD 130000 \
