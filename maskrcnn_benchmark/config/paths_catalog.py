...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "VG_stanford_filtered_with_attribute": {
            "img_dir": "/mnt/hdd1/zhanghaonan/code/code_sgg/vg//VG_100K",
            "roidb_file": "/mnt/hdd1/zhanghaonan/code/code_sgg/vg/VG-SGG-with-attri.h5",
            "dict_file": "/mnt/hdd1/zhanghaonan/code/code_sgg/vg/VG-SGG-dicts-with-attri.json",
            "image_file": "/mnt/hdd1/zhanghaonan/code/code_sgg/vg/image_data.json",
            "capgraphs_file": "/mnt/hdd1/zhanghaonan/code/code_sgg/vg/vg_capgraphs_anno.json",
        },
    }
    ...
    def get(name, cfg):
        if "coco" in name:
            ...
            assert name in DatasetCatalog.DATASETS and split in {
                'train', 'val', 'test'}
            data_dir = DatasetCatalog.DATA_DIR
            ...
            # args['filter_class_num'] = cfg.DATASETS.FILTER_NUM if split == "train" else None
            return dict(
                factory="VGDataset",
                args=args,
            )
