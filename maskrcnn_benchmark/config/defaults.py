...
_C.MODEL.ROI_RELATION_HEAD.USE_CONTEXT = True
...
# when sample fg relationship from gt, the max number of corresponding proposal pairs
...
_C.DETECTED_SGG_DIR = "."
_C.GLOVE_DIR = "."
_C.LOG_DIR = "./logs"  # DO NOT MODIFIED!!
